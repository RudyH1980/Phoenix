defmodule PhoenixAnalyticsWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :phoenix_analytics
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :phoenix_analytics
  end
  ...
  plug PhoenixAnalyticsWeb.Router
end
