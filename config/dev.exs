...
config :phoenix_analytics, PhoenixAnalyticsWeb.Endpoint,
  ...
  url: [host: "localhost", port: 4095, scheme: "http"],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Q3e8fvO/B1SzGXo6h1MARl+Kti3cKjzPp1Y9oOhEDus7MvMLctvHsUH9ClH12ptE",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:phoenix_analytics, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:phoenix_analytics, ~w(--watch)]}
  ]
...
config :phoenix_analytics, PhoenixAnalyticsWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phoenix_analytics_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :phoenix_analytics, dev_routes: true
